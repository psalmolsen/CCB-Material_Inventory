...
public class CnfItem {
    ...
    public enum CnfType { COLLAR, NAMEPLATE, FOOTRING, OTHER }
    ...
    public CnfType getType() {
        if (itemName == null) return CnfType.OTHER;
        String upper = itemName.toUpperCase();
        if (upper.contains("COLLAR"))    return CnfType.COLLAR;
        if (upper.contains("NAME PLATE") || upper.contains("NAMEPLATE")) return CnfType.NAMEPLATE;
        if (upper.contains("FOOT RING")  || upper.contains("FOOTRING"))  return CnfType.FOOTRING;
    ...
    public void   setInitialStock(double v)            { this.initialStock = v; }

    public double getReceivedQuantity()                { return receivedQuantity; }
    public void   setReceivedQuantity(double v)        { this.receivedQuantity = v; }

    public String getDate()                            { return date; }
    public void   setDate(String v)                    { this.date = v; }

    public double getCurrentBalance()                  { return currentBalance; }
    public void   setCurrentBalance(double v)          { this.currentBalance = v; }

    public double getOutQuantity()                     { return outQuantity; }
    public void   setOutQuantity(double v)             { this.outQuantity = v; }

    public int    getSheetRowNumber()                  { return sheetRowNumber; }
    public void   setSheetRowNumber(int v)             { this.sheetRowNumber = v; }

    public String getSheetTabName()                    { return sheetTabName; }
    public void   setSheetTabName(String v)            { this.sheetTabName = v; }
